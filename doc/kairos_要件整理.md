...
| 機能名 | 説明 | 優先度 | 状態 |
|------|-----|-------|-----|
| 位置情報登録 | スマホやPCからの位置情報登録機能 | 高 | 設計完了 |
| 勤怠情報提出先登録 | 提出先情報と規定時刻の新規登録 | 高 | 設計完了 |
| 勤怠情報提出先取得 | 提出先情報と規定時刻の一覧・詳細取得 | 高 | 設計完了 |
| 勤怠情報提出先更新 | 提出先情報と規定時刻の更新 | 高 | 設計完了 |
| 勤怠情報提出先削除 | 提出先情報の削除・無効化 | 中 | 設計完了 |
...
| 2025/06/08 | カーン | 勤怠情報提出先CRUD機能の設計完了：登録・取得・更新・削除機能の詳細設計書を作成 |
